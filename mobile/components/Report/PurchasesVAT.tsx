    ...
    return (
        <View className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            ...
            <View className="flex-row bg-slate-50 px-5 py-3">
                ...
                <Text className="flex-1 text-right text-sm font-semibold text-slate-900">{parseFloat(report.purchase_net).toFixed(2)} €</Text>
                <Text className="flex-1 text-right text-sm font-semibold text-slate-700">{parseFloat(report.purchase_vat_amount).toFixed(2)} €</Text>
                <Text className="flex-1 text-right text-sm font-semibold text-slate-900">{(parseFloat(report.purchase_gross)).toFixed(2)} €</Text>
            </View>
        </View>
    );
};