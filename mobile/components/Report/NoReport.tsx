...
export default function NoReport() {
    return (
        <View className="items-center rounded-xl border border-dashed border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 p-16">
            <Text className="text-lg font-semibold text-slate-900 dark:text-slate-50">Ei vielä raportteja</Text>
