    ...
    return (
        <View className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            ...
            <View className="flex-row bg-slate-50 px-5 py-3">
                ...
                <Text className="flex-1 text-right text-sm font-semibold text-slate-900">{parseFloat(report.sales_net).toFixed(2)} €</Text>
                <Text className="flex-1 text-right text-sm font-semibold text-teal-700">{parseFloat(report.sales_vat_amount).toFixed(2)} €</Text>
                <Text className="flex-1 text-right text-sm font-semibold text-slate-900">{parseFloat(report.sales_gross).toFixed(2)} €</Text>
            </View>
        </View>
    );
};