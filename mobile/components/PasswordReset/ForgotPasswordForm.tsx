    ...
    return (
        <View className="w-full gap-6 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 py-6 shadow-xl shadow-slate-950/10">
            <View className="gap-2 px-6">
                <Text className="text-2xl font-semibold text-slate-950 dark:text-slate-50">Sähköpostivahvistuslinkki</Text>
                <Text className="text-sm leading-6 text-slate-500 dark:text-slate-400">Syötä sähköpostiosoitteesi alle</Text>
            </View>
