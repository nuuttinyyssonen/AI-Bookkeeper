...
export default function DraftBanner({ children }: { children: React.ReactNode }) {
    return (
        <div className="mb-10 flex gap-3 rounded-lg border border-amber-300 bg-amber-50 p-4">
            <AlertTriangle className="mt-0.5 h-5 w-5 flex-none text-amber-600" />
            <div>
                <p className="text-xs font-semibold uppercase tracking-wider text-amber-700">Luonnos</p>
