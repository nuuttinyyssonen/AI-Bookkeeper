...
export default async function resetPassword( _prevState: FormState<EmailInput>, formData: FormData) {
    ...
    try {
        const response = await fetch("http://localhost:5001/api/auth/reset-password/send-email", {
            method: 'POST',
