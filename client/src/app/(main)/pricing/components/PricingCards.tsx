                ...
                return (
                    <div
                        ...
                        className={`relative rounded-lg bg-white p-6 space-y-4 ${
                            isCurrent ? 'border-2 border-teal-700' : plan.popular ? 'border-2 border-slate-200' : 'border border-border'
                        }`}
                    >
                        ...
                        <div>
                            ...
                            <div className="mt-2 flex items-baseline gap-1">
                                <span className="text-3xl font-semibold text-slate-950">{price}</span>
                        ...
                        {isConfirming ? (
                            ...
                            <button
                                ...
                                className={`w-full h-10 rounded-md text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${
                                    isCurrent ? 'bg-slate-100 text-slate-400 border border-slate-200'
