            ...
            <div className="divide-y divide-slate-100 md:hidden">
                    ...
                    <div key={row.rate} className="px-5 py-4">
                        ...
                        <div className="mt-2 grid grid-cols-3 gap-2 text-right">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-medium text-slate-700">{row.vat_amount.toFixed(2)} €</p>
                            </div>
                            <div>
                ...
                <div className="bg-slate-50 px-5 py-4">
                    ...
                    <div className="mt-2 grid grid-cols-3 gap-2 text-right">
                        <div>
                            <p className="text-xs text-slate-500">{t('net')}</p>
                            <p className="text-sm font-semibold text-slate-900">{Number(report.purchase_net).toFixed(2)} €</p>
                        </div>
                        <div>
                            <p className="text-xs text-slate-500">{t('vatAmount')}</p>
                            <p className="text-sm font-semibold text-slate-700">{Number(report.purchase_vat_amount).toFixed(2)} €</p>
                        </div>
                        <div>
                            <p className="text-xs text-slate-500">{t('gross')}</p>
                            <p className="text-sm font-semibold text-slate-900">{Number(report.purchase_gross).toFixed(2)} €</p>
                        </div>
                    </div>
                </div>
            </div>
