...
assistantRouter.get("/:id", demoMiddleware, rateLimiters.read("get_chat_messages"), getMessagesFromChatRoom);
assistantRouter.get("/", demoMiddleware, rateLimiters.read("get_chats"), getChatRooms);
